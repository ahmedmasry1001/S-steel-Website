...
const Projects = () => {
    ...
    >
      <div className="relative overflow-hidden rounded-lg mb-4">
        <div className="w-full h-64 relative">
          ...
          <div 
            className={`w-full h-full bg-gradient-to-br from-steel-gray to-dark-gray flex items-center justify-center ${
              project.main_image || project.image ? 'hidden' : ''
            }`}
          >
  ...
  const ProjectListItem = ({ project, index }) => (
    <motion.div
      ...
      transition={{ duration: 0.5, delay: index * 0.1 }}
    >
      <div className="w-full md:w-80 h-48 rounded-lg flex-shrink-0 relative overflow-hidden">
        {project.main_image || project.image ? (
          <img
            src={project.main_image || project.image}
            alt={project.title}
